...
(def op-maps
  {'$no-value {:sigs [["" "unset"]]
   ...
   'sort-by {:sigs [["'[' symbol:element set ']' (integer-expression | fixed-decimal-expression)" "set"]
                    ["'[' symbol:element vector ']' (integer-expression | fixed-decimal-expression)" "vector"]]
             :j-sigs [["'sortBy' '(' symbol:element 'in' set ')' (integer-expression | fixed-decimal-expression)" "set"]
                      ["'sortBy' '(' symbol:element 'in' vector ')' (integer-expression | fixed-decimal-expression)" "vector"]]}
