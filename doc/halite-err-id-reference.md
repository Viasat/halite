...
Error message template: "Cannot compute absolute value of: :value"
...
Error message template: "Accumulator binding target for ':op' must be a bare symbol, not: :accumulator"
...
Error message template: ":position-text to ':op' must be :expected-type-description"
...
Error message template: "Argument to first is always empty"
...
Error message template: "First argument to 'conj' must be a set or vector"
...
Error message template: "Argument to ':op' must be a vector"
...
Error message template: "Arguments to ':op' must be sets"
...
Error message template: "Binding target for ':op' must be a bare symbol, not: :sym"
...
Error message template: "Cannot bind a value to the reserved word: :sym"
...
Error message template: "Cannot conj possibly unset value to :type-string"
...
Error message template: "Binding form for 'op' must have one variable and one collection"
...
Error message template: "Collection required for ':op', not :actual-type"
...
Error message template: "Cannot divide by zero"
...
Error message template: "Cannot use the same symbol for accumulator and element binding: :element"
...
Error message template: "Element binding target for ':op' must be a bare symbol, not: :element"
...
Error message template: "Variables not defined on spec: :invalid-vars"
...
Error message template: "Value of ':variable' has wrong type"
...
Error message template: "The path parameter in 'get-in' must be a vector literal: :form"
...
Error message template: "First argument to ':op' must be a bare symbol"
...
Error message template: "Index out of bounds, :index, for vector of length :length"
...
Error message template: "Collection value is not of a supported type"
...
Error message template: "Invalid exponent: :exponent"
...
Error message template: "Invalid expression"
...
Error message template: "Invalid instance of ':spec-id', violates constraints :violated-constraints"
...
Error message template: "Index must be a variable name (as a keyword) when target is an instance"
...
Error message template: "The keyword contains invalid characters: :form"
...
Error message template: "The keyword is too long"
...
Error message template: "Lookup target must be an instance of known type or non-empty vector"
...
Error message template: "Invalid refinement expression: :form"
...
Error message template: "The symbol contains invalid characters: :form"
...
Error message template: "The symbol is too long"
...
Error message template: "Expected namespaced keyword as value of :$type"
...
Error message template: "Invalid value"
...
Error message template: "Index must be an integer when target is a vector"
...
Error message template: "Let bindings form must have an even number of forms"
...
Error message template: "Even-numbered forms in let binding vector must be bare symbols"
...
Error message template: ":object-type of :value exceeds the max allowed value of :limit"
...
Error message template: ":coll-type-string literal element must always evaluate to a value"
...
Error message template: "Missing required variables: :missing-vars"
...
Error message template: "Instance literal must have :$type field"
...
Error message template: "Expression provided to 'map' must produce a value: :form"
...
Error message template: "Instance cannot contain abstract value"
...
Error message template: "No matching signature for ':op'"
...
Error message template: "No active refinement path from ':type' to ':target-type'"
...
Error message template: "Body expression in ':op' must be boolean"
...
Error message template: "Constraint expression ':expr' must have Boolean type"
...
Error message template: "When first argument to ':op' is a vector, second argument must also be a vector"
...
Error message template: "Body expression in ':op' must be sortable, not :actual-type"
...
Error message template: "Numeric value overflow"
...
Error message template: "Second binding expression to 'reduce' must be a vector."
...
Error message template: "Refinement from ':type' failed unexpectedly: :underlying-error-message"
...
Error message template: "Resource spec not found: :spec-id"
...
Error message template: ":object-type size of :actual-count exceeds the max allowed size of :count-limit"
...
Error message template: "Multiple elements produced the same sort value, so the collection cannot be deterministically sorted"
...
Error message template: "Spec threw error: :spec-error-str"
...
Error message template: "Symbol ':form' is undefined"
...
Error message template: "Symbols in type environment are not bound: :unbound-symbols"
...
Error message template: "Undefined: ':form'"
...
Error message template: "Unknown function or operator: :op"
...
Error message template: "Value of ':sym has wrong type"
...
Error message template: "Wrong number of arguments to ':op': expected :expected-arg-count, but got :actual-arg-count"
...
Error message template: "Wrong number of arguments to ':op': expected at least :minimum-arg-count, but got :actual-arg-count"
...
Error message template: "Binding expression in ':op' must have an optional type"
...
Error message template: "Binding target for ':op' must not start with '$': :sym"
...
Error message template: "Disallowed binding ':sym' to \colonNothing value; perhaps move to body of 'let'"
...
Error message template: "Disallowed binding ':sym' to \colonUnset value; just use '$no-value'"
...
Error message template: "Disallowed '\colonNothing' expression: :nothing-arg"
...
Error message template: "Disallowed use of Unset variable ':form'; you may want '$no-value'"
...
Error message template: "First argument to ':op' must have an optional type"
...
Error message template: "The path parameter in 'get-in' cannot be empty: :form"
...
Error message template: "Bindings form of 'let' cannot be empty in: :form"
...
Error message template: "Result of ':op' would always be :value"
...
Error message template: "Expected all refinements to have a refinement-e value"
...
Error message template: "Invalid right :right, it must be one of [admin, read, write, delete, purge, register, registry-read, registry-write, registry-publish, registry-delete]"
...
Error message template: "Cannot perform registry op on workspace: :workspace-name with a time value of: :instruction-time which is not after the last instruction time on this workspace of: :last-modified-time"
...
Error message template: "Cannot :op spec that is still published to outside registry: :just-keys"
...
Error message template: "Cannot :op workspace that contains specs registered in other workspaces: :just-keys"
...
Error message template: "Didn't find coercer in cache: :schema-name"
...
Error message template: "Constraint :constraint-name on spec :spec-id must have type Boolean, not :actual-type"
...
Error message template: "Must use halite/jadeite for all expressions"
...
Error message template: "strInvalid characters in group-category :group-category, they must match the regex 'model/group-category-pattern'"
...
Error message template: "strInvalid group-category length :count, it must be <= model/group-category-length-limit"
...
Error message template: "strInvalid characters in group-name :group-name, they must match the regex 'model/group-name-pattern'"
...
Error message template: "strInvalid group-name length :count, it must be <= model/group-name-length-limit"
...
Error message template: "Instructions cannot refer to the same spec twice in a single workspace: :entry-spec-id"
...
Error message template: "Coercion failure at :path : :err value: :orig"
...
Error message template: "Unsuported key :schema-error found in json body"
...
Error message template: "Required key :missing-field not found in json body"
...
Error message template: "VariableType :type in JSON must be string or object"
...
Error message template: "Cannot provide last-transaction-id without \colonsu right"
...
Error message template: "Multiple paths detected: :spec-id :reachable"
...
Error message template: "Must specify whether spec is concrete"
...
Error message template: "cannot combine types: [:types]"
...
Error message template: "Permission not found: :permission"
...
Error message template: "Refinement to :expected-type has wrong type ':actual-type'"
...
Error message template: "Expected all refinements to use halite or jadeite"
...
Error message template: "Did not expect multiple refinements for same spec id"
...
Error message template: "Registry entry must not provide 'is-concrete' value: :instruction"
...
Error message template: "Registry entry must provide 'is-concrete' value: :instruction"
...
Error message template: "Invalid registry-op :registry-op, it must be one of [register, publish, or delete]"
...
Error message template: "spec-id :spec-id not registered in the workspace"
...
Error message template: "Resource Spec :spec-id not found, or access not granted"
...
Error message template: "Resource Spec :resource-spec-name not found, or access not granted"
...
Error message template: "Query parameter version :version not found"
...
Error message template: "Referenced resource spec :spec-id not found, or access not granted"
...
Error message template: "variable-type collections must contain only a collection-type and element-type definition"
...
Error message template: "Resource Spec does not exist, cannot create when version != 0"
...
Error message template: "Resource Spec already exists, cannot perform update when version == 0"
...
Error message template: "strInvalid resource-spec-version :resource-spec-version, it must match the regex model/spec-version-url-pattern or 'latest'"
...
Error message template: "Source registry entry not found: :instruction"
...
Error message template: "Resource spec :spec-id does not exist"
...
Error message template: "strInvalid characters in spec-id :spec-id, they must match the regex 'model/dotted-name/model/user-specid-regex-pattern'"
...
Error message template: "strInvalid spec-id length :count, it must be <= model/user-spec-id-length-limit"
...
Error message template: "spec-id query parameter must be specified"
...
Error message template: "strInvalid characters in spec-name :spec-name, they must match the regex 'model/dotted-name/model/spec-name-regex-pattern'"
...
Error message template: "strInvalid spec-name length :count, it must be <= model/spec-name-length-limit"
...
Error message template: "Spec referenced not in registry: :spec-id"
...
Error message template: "Too many registry instructions (more than :limit): :count"
...
Error message template: "Unexpected result, please contact support"
...
Error message template: "Exception processing request"
...
Error message template: "Variable :variable not defined in resource spec"
...
Error message template: "strInvalid characters in workspace-name :workspace-name, they must match the regex 'model/dotted-name'"
...
Error message template: "strInvalid workspace-name length :count, it must be <= model/workspace-name-length-limit"
...
Error message template: "Workspace :workspace-name not found, or access not granted"
