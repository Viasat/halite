...
(deftest test-fixed-decimal
  ...
  (h (scale #d "1.23" 0) :Integer 1 "scale(1.23, 0)" "1")
  (h (scale #d "1.23" 1) [:Decimal 1] #d "1.2" "scale(1.23, 1)" "1.2")
  (h (scale #d "1.23" 2) [:Decimal 2] #d "1.23" "scale(1.23, 2)" "1.23")
  (h (scale #d "1.23" 3) [:Decimal 3] #d "1.230" "scale(1.23, 3)" "1.230")
  (h (scale #d "1.23" -1) [:throws "Second argument to 'scale' must be an integer between 0 and 18"])
  ...
  (h (reduce [a #{}] [x [0 #d "0.0" #d "0.00"]] (conj a x)) [:Set :Object] #{0 (fixed/fixed "0.00") (fixed/fixed "0.0")} "reduce( a = #{}; x in [0, 0.0, 0.00] ) { a.conj(x) }" "#{0, 0.0, 0.00}")
