...
(defmacro check-propagate [spec-env bom & more]
  `(let [expected-result# ~(third (first more))
     ...
     (swap! test-atom conj (list '~'check-propagate spec-env0# bom0# [lowered-bom# choco-data# result#]))
     [choco-data# result#]))
  ...
  (do
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/A$v1,
       :a {:$value? false,
           :$primitive-type [:Decimal 2]},
       :$constraints {"c1" (= 30 (if false (div (+ #r [:a] 1) 10) 30))}}
      {:choco-spec {:vars {$_0 :Int,
                           $_1 :Bool},
                    :constraints #{(= 30 (if false (div (+ $_0 1) 10) 30))}},
       :choco-bounds {$_0 [-1000 1000],
                      $_1 false},
       :sym-to-path [$_0 [:a] $_1 [:a :$value?]]}
      {:$instance-of :ws/A$v1,
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/A$v1,
       :a 400,
       :$constraints {"c1" (= 30 (if #r [:a :$value?] (div (+ 400 1) 10) 30))}}
      {:choco-spec {:vars {$_0 :Int},
                    :constraints #{(= 30 (if true (div (+ 400 1) 10) 30))}},
       :choco-bounds {$_0 400},
     ...
     [{:$instance-of :ws/B$v1,
       ...
       :a {:$instance-of :ws/A$v1,
           :x {:$primitive-type :Integer,
               :$value? {:$primitive-type :Boolean}},
           :$value? {:$primitive-type :Boolean}},
       :$constraints {"c1" (and #r [:a :$value?]
                                (and #r [:a :x :$value?] (> #r [:a :x] 20)))}}
      {:choco-spec {:vars {$_0 :Bool,
                           $_1 :Bool,
                           $_2 :Int,
                           $_3 :Bool},
                    :constraints #{(and $_1 (and $_3 (> $_2 20)))}},
       :choco-bounds {$_0 false,
                      $_1 #{true false},
                      $_2 [-1000 1000],
                      $_3 #{true false}},
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/B$v1,
       ...
       :$constraints {"c1" (or #r [:b]
                               (and #r [:a :$value?]
                                    (and #r [:a :x :$value?] (> 30 20))))}}
      {:choco-spec {:vars {$_0 :Bool,
                           $_1 :Int,
                           $_2 :Bool,
                           $_3 :Bool},
                    :constraints #{(or $_2 (and $_0 (and true (> 30 20))))}},
       :choco-bounds {$_0 #{true false},
                      $_1 30,
                      $_2 #{true false},
                      $_3 true},
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/B$v1,
       ...
       :$constraints {"c1" (or #r [:b]
                               (and #r [:a :$value?]
                                    (and #r [:a :x :$value?] (> 10 20))))}}
      {:choco-spec {:vars {$_0 :Bool,
                           $_1 :Int,
                           $_2 :Bool,
                           $_3 :Bool},
                    :constraints #{(or $_2 (and $_0 (and true (> 10 20))))}},
       :choco-bounds {$_0 #{true false},
                      $_1 10,
                      $_2 #{true false},
                      $_3 true},
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/A$v1,
       ...
       {"c2$0" {:x {:$expr #r [:a]},
                :y {:$expr (+ #r [:a] #r [:b] 2)},
                :$instance-literal-type :ws/X$v1,
                :$constraints {"c1" (= 10 (+ #r [:a] (+ #r [:a] #r [:b] 2)))}},
        "c2$1"
        {:q
         {:$expr
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/X$v1,
       :x 20,
       :$constraints {"c1" (or (not #r [:x :$value?]) (> 20 10))}}
      {:choco-spec {:vars {$_0 :Int},
                    :constraints #{(or (not true) (> 20 10))}},
       :choco-bounds {$_0 20},
       :sym-to-path [$_0 [:x]]}
      {:$instance-of :ws/X$v1,
       :x 20}])
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/X$v1,
       :x 10,
       :$constraints {"c1" (or (not #r [:x :$value?]) (> 10 10))}}
      {:choco-spec {:vars {$_0 :Int},
                    :constraints #{(or (not true) (> 10 10))}},
       :choco-bounds {$_0 10},
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/A$v1,
      ...
      {:choco-spec {:vars {$_0 :Int,
                           $_1 :Bool},
                    :constraints #{(or (not $_1) (= 10 (+ $_0 7))) false}},
       :choco-bounds {$_0 [-1000 1000],
                      $_1 false},
       :sym-to-path [$_0 [:a] $_1 [:a :$value?]]} {:$contradiction? true}])
     ...
     [{:$instance-of :ws/A$v1,
       ...
       {"c2$0" {:x {:$expr #r [:a]},
        ...
        "c2$1" {:q {:$expr #instance {:x #r [:a], :y 7, :$type :ws/X$v1}},
                :$instance-literal-type :ws/P$v1}}}
      {:choco-spec {:vars {$_0 :Int},
                    :constraints #{(or (not true) (= 10 (+ $_0 7))) true}},
       :choco-bounds {$_0 4},
       :sym-to-path [$_0 [:a]]} {:$contradiction? true}])
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/A$v1,
      ...
      {:choco-spec {:vars {$_0 :Int,
                           $_1 :Bool},
                    :constraints #{true (or (not $_1) (= 10 (+ $_0 7)))}},
       :choco-bounds {$_0 [-1000 1000],
                      $_1 #{true false}},
       :sym-to-path [$_0 [:a] $_1 [:a :$value?]]}
      {:$instance-of :ws/A$v1,
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/A$v1,
      ...
      {:choco-spec {:vars {$_0 :Int,
                           $_1 :Bool},
                    :constraints #{(or (not (> $_0 0)) (= 10 (+ $_0 6))) true}},
       :choco-bounds {$_0 [-1000 1000],
                      $_1 true},
       :sym-to-path [$_0 [:a] $_1 [:a :$value?]]}
      {:$instance-of :ws/A$v1,
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/A$v1,
      ...
      {:choco-spec {:vars {$_0 :Int,
                           $_1 :Bool},
                    :constraints #{(or (not $_1) (= 10 (+ $_0 6))) true}},
       :choco-bounds {$_0 [-1000 1000],
                      $_1 true},
       :sym-to-path [$_0 [:a] $_1 [:a :$value?]]}
      {:$instance-of :ws/A$v1,
       ...
       :$instance-literals {"c2$0" {:x {:$expr #r [:a]},
                                    ...
                                    :$constraints {"c1" (or (not #r [:a :$value?])
                                                            (= 10
                                                               (+ #r [:a] 6)))}}}}
      {:choco-spec {:vars {$_0 :Int},
                    :constraints #{(or (not true) (= 10 (+ $_0 6))) true}},
       :choco-bounds {$_0 3},
       :sym-to-path [$_0 [:a]]} {:$contradiction? true}])
    ...
    (check-propagate
     ...
     [{:$instance-of :ws/A$v1,
      ...
      {:choco-spec {:vars {$_0 :Int,
                           $_1 :Bool},
                    :constraints #{(or (not $_1) (= 10 (+ $_0 6))) false}},
       :choco-bounds {$_0 [-1000 1000],
                      $_1 false},
       :sym-to-path [$_0 [:a] $_1 [:a :$value?]]} {:$contradiction? true}])
